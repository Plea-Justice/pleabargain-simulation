...
if (this.assetPalette.figure == 0 && this.assetPalette.eyes == 0)	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1));
	...
	this.instance_8.setTransform(-196.5,233.75,0.5,0.5);
...
if (this.assetPalette.figure == 1 && this.assetPalette.eyes == 0)	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(1));
	...
	this.instance_16.setTransform(-196.5,229.8,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(1));

	// Background
	this.instance_17 = new lib.CachedBmp_18();
	this.instance_17.setTransform(-842.5,142.4,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(117.5,682.4,1645.5,966.4);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/AllScenarios_PhoneRoom_atlas_.png", id:"AllScenarios_PhoneRoom_atlas_"}
	],
	preloads: []
};
